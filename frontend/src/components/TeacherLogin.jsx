        ...
        <div className="login-container fade-in page-wrapper">
            <div className="login-card">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="forgot-password">
                        <a href="/teacher/email-lookup" className="btn btn-link p-0">Forgot your email? Lookup by Teacher ID</a>
                    </div>
                    <div className="text-center mt-3">
                        <button className="btn btn-link" onClick={() => navigate('/teacher/register')}>
